...
urlpatterns = [
  path('', views.home_page_render, name='home_page_render'),
  ...
  path('categories/<int:pk>/posts/<int:fk>', views.post_detail, name='post_detail'),
  path('categories/<int:pk>/posts/<int:fk>/delete', views.delete_post, name='delete_post')
